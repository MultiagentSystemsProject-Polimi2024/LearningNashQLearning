    ...
    def nashQlearning(self, episodes, alfa, gamma, epsilon, pure_training_ep, decaying_epsilon, reset = False):
        ...
        for t in range(episodes):
            ...
            if(reset and self.goal_state != None and state == self.goal_state):
                next_state = 0
                """be cautious to the qTable updates... in case u wanna delete this just delete also reset par"""
            else:
            ...
            for i in range(self.n_players):
                ...
                """is this necessary???"""
                #compute Nash Equilibrium for the current state and memorize it
