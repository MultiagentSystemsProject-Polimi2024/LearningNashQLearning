...
class PresetGames:
    ...
    def __secondSetup(self):
        ...
        for i in range(2):
            for j in range(2):
                for k in range(2):
                    games[0].setTransition((i, j, k), 0, 0)
                    games[0].setTransition((i, j, k), 1, 0)
        ...
        for i in range(2):
            for j in range(2):
                for k in range(2):
                    games[1].setTransition((i, j, k), 0, 0)
                    games[1].setTransition((i, j, k), 1, 0)
    ...
    def __thirdSetup(self):
        ...
        for i in range(2):
            for j in range(2):
                for k in range(2):
                    for l in range(2):
                        games[0].setTransition((i, j, k, l), 0, 0)
                        games[0].setTransition((i, j, k, l), 1, 0)
        ...
        for i in range(2):
            for j in range(2):
                for k in range(2):
                    for l in range(2):
                        games[1].setTransition((i, j, k, l), 0, 0)
                        games[1].setTransition((i, j, k, l), 1, 0)
